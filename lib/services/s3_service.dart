...
class S3Service {
  ...
  Future<String> _uploadToS3({
    ...
    try {
      ...
      final url = Uri.https('$_bucketName.s3.$_region.amazonaws.com', s3Key);
  ...
  Future<Uri> getPresignedUrl({
    ...
    final url = Uri.https('$_bucketName.s3.$_region.amazonaws.com', normalizedKey);
    print('✅ URL generada: ${url.toString().substring(0, url.toString().length > 80 ? 80 : url.toString().length)}...');
    return url;
  }
  ...
  String _normalizeKey(String key) {
    ...
    return key.replaceFirst('s3://$_bucketName/', '').replaceFirst('/$_bucketName/', '');
  }
